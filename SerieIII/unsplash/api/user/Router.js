...
class UserRouter {
  ...
  registerRoutes () {
    this._router.get('/', this._checkToken('edit'), this.handleGetUsers.bind(this))
    this._router.get('/:id', this._checkToken('edit'), this.handleGetUser.bind(this))
    this._router.post('/signup', this._validations, this.handlePostUser.bind(this))
    this._router.delete('/:id', this._checkToken('edit'), this.handleDeleteUser.bind(this))
