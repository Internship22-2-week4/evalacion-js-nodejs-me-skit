...
class AlbumRouter {
  ...
  registerRoutes () {
    this._router.get('/', this._checkToken('edit'), this.handleGetAlbums.bind(this))
    this._router.get('/:id', this._checkToken('edit'), this.handleGetAlbum.bind(this))
    this._router.post('/', [this._checkToken('edit'), this._validations], this.handlePostAlbum.bind(this))
    this._router.delete('/:id', this._checkToken('edit'), this.handleDeleteAlbum.bind(this))
    this._router.put('/:id', this._checkToken('edit'), this.handleUpdateAlbum.bind(this))
  }
